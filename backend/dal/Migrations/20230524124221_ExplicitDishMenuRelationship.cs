...
{
    /// <inheritdoc />
    public partial class ExplicitDishMenuRelationship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishesInMenu", x => new { x.DishId, x.MenuId });
                    table.ForeignKey(
                        name: "FK_DishesInMenu_Dishes_DishId",
                        column: x => x.DishId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DishesInMenu_Menus_MenuId",
                        column: x => x.MenuId,
